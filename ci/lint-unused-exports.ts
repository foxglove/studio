...
async function main(): Promise<void> {
  const { stdout, status } = await execOutput(
    ...
    [
      ...
      "--error",
      "--ignore",
      `used in module|^packages/(hooks|den)/|/studio-base/src/index\\.ts|/studio-base/src/stories/|/studio-base/src/test/|/nodeTransformerWorker/typescript/userUtils|\\.stories\\.ts|/\\.storybook/`,
