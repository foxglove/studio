  ...
  return {
    ...
    plugins: [
      ...
      new ForkTsCheckerWebpackPlugin({
        typescript: {
          // Note: configFile should not be overridden, it needs to differ between web, desktop, etc.
          // so that files specific to each build (not just shared files) are also type-checked.
          configOverwrite: {
            compilerOptions: {
