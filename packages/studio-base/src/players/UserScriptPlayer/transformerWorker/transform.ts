...
export const getInputTopics = (nodeData: ScriptData): ScriptData => {
...
export const getOutputTopic = (nodeData: ScriptData): ScriptData => {
...
export const validateInputTopics = (nodeData: ScriptData, topics: Topic[]): ScriptData => {
...
export const compile = (nodeData: ScriptData): ScriptData => {
...
export const extractGlobalVariables = (nodeData: ScriptData): ScriptData => {
...
export const extractDatatypes = (nodeData: ScriptData): ScriptData => {
  // Do not attempt to run if there were any compile time errors.
  if (hasTransformerErrors(nodeData)) {
    return nodeData;
  }
...
export const compose = (...transformers: ScriptDataTransformer[]): ScriptDataTransformer => {
  return (nodeData: ScriptData, topics: Topic[]) => {
