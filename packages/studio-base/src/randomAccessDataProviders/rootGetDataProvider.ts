...
import MessageMemoryCacheDataProvider from "@foxglove/studio-base/randomAccessDataProviders/MessageMemoryCacheDataProvider";
...
const getDataProviderBase = createGetDataProvider({
  ...
  MessageMemoryCacheDataProvider,
