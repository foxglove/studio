...
import { PanelGrid } from "@foxglove/studio-base/components/PanelGrid/PanelGrid";
...
export default {
  title: "components/PanelGrid",
  component: () => <PanelGrid onPanelSelect={() => {}} />,
  args: {},
...
export const FilteredByDescription: Story = {
  args: { inputValue: "description" },
};
