...
import { getRotationWithScaling, mat4Identity, quatIdentity, vec3Identity } from "./geometry";

const tempScale = vec3Identity();

function approxeq(v1: number, v2: number, epsilon = 0.001): boolean {
...
export class Transform {
  ...
  setMatrix(matrix: ReadonlyMat4): this {
    ...
    // This is the same as mat4.getRotation() but with precomputed scaling
    getRotationWithScaling(this._rotation, matrix, tempScale);
    return this;
  }
