...
export class LineListRenderable extends THREE.Object3D {
  ...
  public update(
    ...
    const { points, outlineColor, outlineColors, thickness } = annotation;
    ...
    this.#material.linewidth = thickness * scale;
