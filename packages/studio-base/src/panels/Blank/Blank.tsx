...
function Content({ showLogo }: { showLogo: boolean }): JSX.Element {
  const { classes } = useStyles();

  return (
    <div className={classes.root}>
      {showLogo && (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 909 204">
          <g fill="currentColor">
...
export default function Blank({ context }: BlankPanelProps): JSX.Element {
  ...
  return (
    <ThemeProvider isDark={colorScheme === "dark"}>
      <Content showLogo={config.showLogo} />
    </ThemeProvider>
  );
}
